...
- [OpenApi спецификация](openapi.yml), которую можно посмотреть используя онлайн [https://editor.swagger.io/](редактор);
...
- Claude Sonnet 5 (браузерная версия) - [https://claude.ai/share/fef6a4b6-503c-49c8-a528-63d2e65137ae](чат)
- Deepseek (браузерный) - [https://chat.deepseek.com/share/fe00oqenkexoy1yrk3](чат)
...
# Или если нужно запустить тесты
# cp deploy/test/* .
